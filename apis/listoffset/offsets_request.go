...
func (r *OffsetsRequest) Encode(e protocol.PacketEncoder, version int16) error {
	var err error
	e.PutInt32(-1)
...
func (r *OffsetsRequest) Decode(d protocol.PacketDecoder, version int16) error {
	var err error
