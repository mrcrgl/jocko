...
func (r *LeaderAndISRRequest) Encode(e protocol.PacketEncoder, _ int16) error {
	var err error
...
func (r *LeaderAndISRRequest) Decode(d protocol.PacketDecoder, _ int16) error {
	var err error
...
func (r *LeaderAndISRRequest) Key() int16 {
	return protocol.LeaderAndISRKey
}
