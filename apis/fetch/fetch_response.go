...
func (r *FetchResponses) Encode(e protocol.PacketEncoder, version int16) (err error) {
	if version >= 1 {
...
func (r *FetchResponses) Decode(d protocol.PacketDecoder, version int16) error {
	var err error
