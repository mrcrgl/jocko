...
func (c *CreateTopicRequests) Encode(e protocol.PacketEncoder, _ int16) error {
...
func (c *CreateTopicRequests) Decode(d protocol.PacketDecoder, _ int16) error {
	var err error
...
func (c *CreateTopicRequests) Key() int16 {
	return protocol.CreateTopicsKey
}
